...
import com.denizbyrk.sffecommerce.user_service.filter.InternalAuthFilter;
...
public class SecurityConfig {
    ...
    public SecurityConfig(JwtAuthFilter jwtAuthFilter, JwtAuthEntryPoint jwtAuthEntryPoint, JwtAccessDeniedHandler jwtAccessDeniedHandler, InternalAuthFilter internalAuthFilter) {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        http
                ...
                .addFilterBefore(this.internalAuthFilter, UsernamePasswordAuthenticationFilter.class);
